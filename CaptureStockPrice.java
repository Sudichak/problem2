...
public class CaptureStockPrice 
{
	WebDriver driver;
	public String url = "https://www1.nseindia.com/#";
	String driverPath = "C:\\\\Users\\\\sudichak\\\\eclipse-workspace\\\\chromedriver_win32 (2)\\\\chromedriver.exe";
  @Test
		 ...
		 try
		   {
			   ...
			   System.out.println(" date while the price is captured: " +date1);
			   System.out.println(" time while the price is captured: " +time1);		  
